...
- [Design the auto-monitor that watches the backend while harvesting](workflow/wayfinder/maps/harvest-verification/tickets/HV3-auto-monitor.md): `scripts/harvest-verify.mjs:1` polls J/L/C/D/H/P/Q 1.5s, handles busy/400/503/429/402, emits `state/harvest-verify/<jobId>.json` + HV5 verdict — ` --mock` demos pass, live/dry via API.
