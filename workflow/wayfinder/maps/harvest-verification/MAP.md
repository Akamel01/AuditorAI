...
- [HV4-harness](workflow/wayfinder/maps/harvest-verification/tickets/HV4-harness.md): one-command harnesses for API gap, API harvest-stream, and UI gates; blocks HV6/HV7 until verified. 
