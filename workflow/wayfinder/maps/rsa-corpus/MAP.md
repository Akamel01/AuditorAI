...
- [Migration + ratification + promotion executed 2026-09-13]: MOVE_MANIFEST signed → tree migrated (usa/canada/intl/quarantine, loss-proof 351/351, indexes rebuilt 333 1:1 `8c4f310d…`); quote pack RATIFIED 20/20 (F1 gate OPEN; F1 partial — fresh Tier-1 blocked on Zen judge 401, key rejected, no spend); C9 promoted 5 CLEAR → sample-corpus 83 (2 CA held).
